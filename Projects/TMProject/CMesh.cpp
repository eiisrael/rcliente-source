...
int CMesh::Render(int nBright)
{
    ...
    if (nPartIndex >= 2889 && nPartIndex <= 2901 || nPartIndex >= 2906 && nPartIndex <= 2909)
    {
        ...
        if (m_pParentSkin->m_Look.Mesh7 == 2924 //effeito das armas novas
            || m_pParentSkin->m_Look.Mesh7 == 2925
            || m_pParentSkin->m_Look.Mesh7 == 2926
            || m_pParentSkin->m_Look.Mesh7 == 2927
            || m_pParentSkin->m_Look.Mesh7 == 2928
            || m_pParentSkin->m_Look.Mesh7 == 2929
            || m_pParentSkin->m_Look.Mesh7 == 2930
            || m_pParentSkin->m_Look.Mesh7 == 2931
            || m_pParentSkin->m_Look.Mesh7 == 2932
            || m_pParentSkin->m_Look.Mesh7 == 2933
            || m_pParentSkin->m_Look.Mesh7 == 2934
            || m_pParentSkin->m_Look.Mesh7 == 2935)
        {
            int nBaseIndex = 488;//ok
            if (m_sLegendType == 6)
                nBaseIndex = 476;//ok
            if (m_sLegendType == 7)
                nBaseIndex = 500;//ok
...
int CMesh::RenderMesh(char cAlpha)
{
        ...
        || m_sLegendType >= 4 && m_sLegendType <= 8)
    {
        ...
        else if (m_sLegendType > 4 && m_sLegendType <= 8)
        {
            ...
            if (cAlpha != 'A' || g_pDevice->m_bVoodoo || g_pDevice->m_bIntel || g_pDevice->m_bG400)
            {
                g_pDevice->SetTextureStageState(0, D3DTEXTURESTAGESTATETYPE::D3DTSS_ALPHAOP, D3DTEXTUREOP::D3DTOP_SELECTARG1);
                g_pDevice->SetTextureStageState(1, D3DTEXTURESTAGESTATETYPE::D3DTSS_ALPHAOP, D3DTEXTUREOP::D3DTOP_DISABLE);
                g_pDevice->SetTextureStageState(0, D3DTEXTURESTAGESTATETYPE::D3DTSS_ALPHAARG1, D3DTEXTUREOP::D3DTOP_SELECTARG1);
