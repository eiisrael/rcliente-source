...
constexpr unsigned int WYDCOLOR_ALPHA(unsigned int color) { return color & Black; }
...
constexpr unsigned int WYD_RGBA(unsigned int r, unsigned int  g, unsigned int  b, unsigned int  a) { 
    return ((DWORD)((a | Black) | (b & 0xFF) | ((g << 8) & 0xFF00) | ((r << 16) & 0xFF0000)));
}
...
extern std::vector<LojaDonate>			ControlLojaDonate;
extern LojaDonateInfor ControlLojaDonateInfor;
...
const static stTeleportPos g_TeleportTable[] =
{
  ...
  { 188, 556, 0, g_pMessageStringTable[1370] },//batalha
  { 145, 556, 0, g_pMessageStringTable[1370] },//batalha
  { 145, 616, 0, g_pMessageStringTable[1370] },//batalha
  { 188, 616, 0, g_pMessageStringTable[1370] }//batalha
};
