...
constexpr const char* GameWindow_Title = "Play WYD - Universo do Caos.";

/* File related defines */
constexpr const char* LogFile_Path = "clientlogs.log";
...
//UI Related
constexpr const char* TextureListNList_Path = "UI\\UITextureListN.txt";
