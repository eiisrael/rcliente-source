...
TMSkinMesh::TMSkinMesh(LOOK_INFO* pLook, SANC_INFO* pSanc, int nBoneAniIndex, int bExpand, SANC_INFO* pColor, short nMeshType, short nCos, int mount)
{
	...
	if (nBoneAniIndex >= MAX_ANI_TYPE)
		m_dwStartTime = 175 * (((m_nBoneAniIndex >> 1) % 5) + 6);// deixa asa fluida
...
void TMSkinMesh::RenderEffect_HorseFireLeg()
{
	...
	for (int i = 0; i < 4; i++)
	{
		...
		if (mpBill[i])
		{
			...
			mpBill[i]->SetColor(j > 3 ? 0xFFFF1111 : White);
...
void TMSkinMesh::SetCostume(int Costype, char* szTexture, char* szName)//controle de trajes
{
	...
	else
	{
		...
		case 161:
			strcpy(szTexture, "mesh\\ch0101234.wys");
			switch (m_Cos)
			{
			case 1:
				strcpy(szName, "mesh\\ch0101234.msh");
				m_Cos = 2;
				break;
			case 2:
				strcpy(szName, "mesh\\ch0102234.msh");
				m_Cos = 3;
				break;
			case 3:
				strcpy(szName, "mesh\\ch0103234.msh");
				m_Cos = 4;
				break;
			case 4:
				strcpy(szName, "mesh\\ch0104234.msh");
				m_Cos = 5;
				break;
			case 5:
				strcpy(szName, "mesh\\ch0105234.msh");
				m_Cos = 6;
				break;
			case 6:
				strcpy(szName, "mesh\\ch0106234.msh");
				m_Cos = 1;
				break;
			}
			break;
		...
		case 162:
			strcpy(szTexture, "mesh\\ch0101233.wys");
			switch (m_Cos)
			{
			case 1:
				strcpy(szName, "mesh\\ch0101233.msh");
				m_Cos = 2;
				break;
			case 2:
				strcpy(szName, "mesh\\ch0102233.msh");
				m_Cos = 3;
				break;
			case 3:
				strcpy(szName, "mesh\\ch0103233.msh");
				m_Cos = 4;
				break;
			case 4:
				strcpy(szName, "mesh\\ch0104233.msh");
				m_Cos = 5;
				break;
			case 5:
				strcpy(szName, "mesh\\ch0105233.msh");
				m_Cos = 6;
				break;
			case 6:
				strcpy(szName, "mesh\\ch0106233.msh");
				m_Cos = 1;
				break;
			}
			break;
		...
		case 163:
			strcpy(szTexture, "mesh\\ch0101232.wys");
			switch (m_Cos)
			{
			case 1:
				strcpy(szName, "mesh\\ch0101232.msh");
				m_Cos = 2;
				break;
			case 2:
				strcpy(szName, "mesh\\ch0102232.msh");
				m_Cos = 3;
				break;
			case 3:
				strcpy(szName, "mesh\\ch0103232.msh");
				m_Cos = 4;
				break;
			case 4:
				strcpy(szName, "mesh\\ch0104232.msh");
				m_Cos = 5;
				break;
			case 5:
				strcpy(szName, "mesh\\ch0105232.msh");
				m_Cos = 6;
				break;
			case 6:
				strcpy(szName, "mesh\\ch0106232.msh");
				m_Cos = 1;
				break;
			}
			break;
		...
		case 164:
			strcpy(szTexture, "mesh\\ch0101235.wys");
			switch (m_Cos)
			{
			case 1:
				strcpy(szName, "mesh\\ch0101235.msh");
				m_Cos = 2;
				break;
			case 2:
				strcpy(szName, "mesh\\ch0102235.msh");
				m_Cos = 3;
				break;
			case 3:
				strcpy(szName, "mesh\\ch0103235.msh");
				m_Cos = 4;
				break;
			case 4:
				strcpy(szName, "mesh\\ch0104235.msh");
				m_Cos = 5;
				break;
			case 5:
				strcpy(szName, "mesh\\ch0105235.msh");
				m_Cos = 6;
				break;
			case 6:
				strcpy(szName, "mesh\\ch0106235.msh");
				m_Cos = 1;
				break;
			}
			break;
		...
		case 165:
			strcpy(szTexture, "mesh\\ch0101236.wys");
			switch (m_Cos)
			{
			case 1:
				strcpy(szName, "mesh\\ch0101236.msh");
				m_Cos = 2;
				break;
			case 2:
				strcpy(szName, "mesh\\ch0102236.msh");
				m_Cos = 3;
				break;
			case 3:
				strcpy(szName, "mesh\\ch0103236.msh");
				m_Cos = 4;
				break;
			case 4:
				strcpy(szName, "mesh\\ch0104236.msh");
				m_Cos = 5;
				break;
			case 5:
				strcpy(szName, "mesh\\ch0105236.msh");
				m_Cos = 6;
				break;
			case 6:
				strcpy(szName, "mesh\\ch0106236.msh");
				m_Cos = 1;
				break;
			}
			break;
		case 166:
			strcpy(szTexture, "mesh\\ch0101237.wys");
			switch (m_Cos)
			{
			case 1:
				strcpy(szName, "mesh\\ch0101237.msh");
				m_Cos = 2;
				break;
			case 2:
				strcpy(szName, "mesh\\ch0102237.msh");
				m_Cos = 3;
				break;
			case 3:
				strcpy(szName, "mesh\\ch0103237.msh");
				m_Cos = 4;
				break;
			case 4:
				strcpy(szName, "mesh\\ch0104237.msh");
				m_Cos = 5;
				break;
			case 5:
				strcpy(szName, "mesh\\ch0105237.msh");
				m_Cos = 6;
				break;
			case 6:
				strcpy(szName, "mesh\\ch0106237.msh");
				m_Cos = 1;
				break;
			}
			break;
		...
		case 167:
			strcpy(szTexture, "mesh\\ch0101238.wys");
			switch (m_Cos)
			{
			case 1:
				strcpy(szName, "mesh\\ch0101238.msh");
				m_Cos = 2;
				break;
			case 2:
				strcpy(szName, "mesh\\ch0102238.msh");
				m_Cos = 3;
				break;
			case 3:
				strcpy(szName, "mesh\\ch0103238.msh");
				m_Cos = 4;
				break;
			case 4:
				strcpy(szName, "mesh\\ch0104238.msh");
				m_Cos = 5;
				break;
			case 5:
				strcpy(szName, "mesh\\ch0105238.msh");
				m_Cos = 6;
				break;
			case 6:
				strcpy(szName, "mesh\\ch0106238.msh");
				m_Cos = 1;
				break;
			}
			break;
		...
		case 168:
			strcpy(szTexture, "mesh\\ch0101239.wys");
			switch (m_Cos)
			{
			case 1:
				strcpy(szName, "mesh\\ch0101239.msh");
				m_Cos = 2;
				break;
			case 2:
				strcpy(szName, "mesh\\ch0102239.msh");
				m_Cos = 3;
				break;
			case 3:
				strcpy(szName, "mesh\\ch0103239.msh");
				m_Cos = 4;
				break;
			case 4:
				strcpy(szName, "mesh\\ch0104239.msh");
				m_Cos = 5;
				break;
			case 5:
				strcpy(szName, "mesh\\ch0105239.msh");
				m_Cos = 6;
				break;
			case 6:
				strcpy(szName, "mesh\\ch0106239.msh");
				m_Cos = 1;
				break;
			}
			break;
		...
		case 169:
			strcpy(szTexture, "mesh\\ch0101240.wys");
			switch (m_Cos)
			{
			case 1:
				strcpy(szName, "mesh\\ch0101240.msh");
				m_Cos = 2;
				break;
			case 2:
				strcpy(szName, "mesh\\ch0102240.msh");
				m_Cos = 3;
				break;
			case 3:
				strcpy(szName, "mesh\\ch0103240.msh");
				m_Cos = 4;
				break;
			case 4:
				strcpy(szName, "mesh\\ch0104240.msh");
				m_Cos = 5;
				break;
			case 5:
				strcpy(szName, "mesh\\ch0105240.msh");
				m_Cos = 6;
				break;
			case 6:
				strcpy(szName, "mesh\\ch0106240.msh");
				m_Cos = 1;
				break;
			}
			break;
		...
		case 170:
			strcpy(szTexture, "mesh\\ch0101241.wys");
			switch (m_Cos)
			{
			case 1:
				strcpy(szName, "mesh\\ch0101241.msh");
				m_Cos = 2;
				break;
			case 2:
				strcpy(szName, "mesh\\ch0102241.msh");
				m_Cos = 3;
				break;
			case 3:
				strcpy(szName, "mesh\\ch0103241.msh");
				m_Cos = 4;
				break;
			case 4:
				strcpy(szName, "mesh\\ch0104241.msh");
				m_Cos = 5;
				break;
			case 5:
				strcpy(szName, "mesh\\ch0105241.msh");
				m_Cos = 6;
				break;
			case 6:
				strcpy(szName, "mesh\\ch0106241.msh");
				m_Cos = 1;
				break;
			}
			break;
		...
		case 171:
			strcpy(szTexture, "mesh\\ch0101242.wys");
			switch (m_Cos)
			{
			case 1:
				strcpy(szName, "mesh\\ch0101242.msh");
				m_Cos = 2;
				break;
			case 2:
				strcpy(szName, "mesh\\ch0102242.msh");
				m_Cos = 3;
				break;
			case 3:
				strcpy(szName, "mesh\\ch0103242.msh");
				m_Cos = 4;
				break;
			case 4:
				strcpy(szName, "mesh\\ch0104242.msh");
				m_Cos = 5;
				break;
			case 5:
				strcpy(szName, "mesh\\ch0105242.msh");
				m_Cos = 6;
				break;
			case 6:
				strcpy(szName, "mesh\\ch0106242.msh");
				m_Cos = 1;
				break;
			}
			break;
		...
		case 172:
			strcpy(szTexture, "mesh\\ch0101243.wys");
			switch (m_Cos)
			{
			case 1:
				strcpy(szName, "mesh\\ch0101243.msh");
				m_Cos = 2;
				break;
			case 2:
				strcpy(szName, "mesh\\ch0102243.msh");
				m_Cos = 3;
				break;
			case 3:
				strcpy(szName, "mesh\\ch0103243.msh");
				m_Cos = 4;
				break;
			case 4:
				strcpy(szName, "mesh\\ch0104243.msh");
				m_Cos = 5;
				break;
			case 5:
				strcpy(szName, "mesh\\ch0105243.msh");
				m_Cos = 6;
				break;
			case 6:
				strcpy(szName, "mesh\\ch0106243.msh");
				m_Cos = 1;
				break;
			}
			break;
		...
		case 173:
			strcpy(szTexture, "mesh\\ch0101244.wys");
			switch (m_Cos)
			{
			case 1:
				strcpy(szName, "mesh\\ch0101244.msh");
				m_Cos = 2;
				break;
			case 2:
				strcpy(szName, "mesh\\ch0102244.msh");
				m_Cos = 3;
				break;
			case 3:
				strcpy(szName, "mesh\\ch0103244.msh");
				m_Cos = 4;
				break;
			case 4:
				strcpy(szName, "mesh\\ch0104244.msh");
				m_Cos = 5;
				break;
			case 5:
				strcpy(szName, "mesh\\ch0105244.msh");
				m_Cos = 6;
				break;
			case 6:
				strcpy(szName, "mesh\\ch0106244.msh");
				m_Cos = 1;
				break;
			}
			break;
		...
		case 174:
			strcpy(szTexture, "mesh\\ch0101245.wys");
			switch (m_Cos)
			{
			case 1:
				strcpy(szName, "mesh\\ch0101245.msh");
				m_Cos = 2;
				break;
			case 2:
				strcpy(szName, "mesh\\ch0102245.msh");
				m_Cos = 3;
				break;
			case 3:
				strcpy(szName, "mesh\\ch0103245.msh");
				m_Cos = 4;
				break;
			case 4:
				strcpy(szName, "mesh\\ch0104245.msh");
				m_Cos = 5;
				break;
			case 5:
				strcpy(szName, "mesh\\ch0105245.msh");
				m_Cos = 6;
				break;
			case 6:
				strcpy(szName, "mesh\\ch0106245.msh");
				m_Cos = 1;
				break;
			}
			break;
		...
		case 175:
			strcpy(szTexture, "mesh\\ch0101217.wys");
			switch (m_Cos)
			{
			case 1:
				strcpy(szName, "mesh\\ch0101217.msh");
				m_Cos = 2;
				break;
			case 2:
				strcpy(szName, "mesh\\ch0102217.msh");
				m_Cos = 3;
				break;
			case 3:
				strcpy(szName, "mesh\\ch0103217.msh");
				m_Cos = 4;
				break;
			case 4:
				strcpy(szName, "mesh\\ch0104217.msh");
				m_Cos = 5;
				break;
			case 5:
				strcpy(szName, "mesh\\ch0105217.msh");
				m_Cos = 6;
				break;
			case 6:
				strcpy(szName, "mesh\\ch0106217.msh");
				m_Cos = 1;
				break;
			}
			break;
		...
		case 176:
			strcpy(szTexture, "mesh\\ch0101218.wys");
			switch (m_Cos)
			{
			case 1:
				strcpy(szName, "mesh\\ch0101218.msh");
				m_Cos = 2;
				break;
			case 2:
				strcpy(szName, "mesh\\ch0102218.msh");
				m_Cos = 3;
				break;
			case 3:
				strcpy(szName, "mesh\\ch0103218.msh");
				m_Cos = 4;
				break;
			case 4:
				strcpy(szName, "mesh\\ch0104218.msh");
				m_Cos = 5;
				break;
			case 5:
				strcpy(szName, "mesh\\ch0105218.msh");
				m_Cos = 6;
				break;
			case 6:
				strcpy(szName, "mesh\\ch0106218.msh");
				m_Cos = 1;
				break;
			}
			break;
		case 185:
			strcpy(szTexture, "mesh\\ch0101227.wys");
			switch (m_Cos)
			{
			case 1:
				strcpy(szName, "mesh\\ch0101227.msh");
				m_Cos = 2;
				break;
			case 2:
				strcpy(szName, "mesh\\ch0102227.msh");
				m_Cos = 3;
				break;
			case 3:
				strcpy(szName, "mesh\\ch0103227.msh");
				m_Cos = 4;
				break;
			case 4:
				strcpy(szName, "mesh\\ch0104227.msh");
				m_Cos = 5;
				break;
			case 5:
				strcpy(szName, "mesh\\ch0105227.msh");
				m_Cos = 6;
				break;
			case 6:
				strcpy(szName, "mesh\\ch0106227.msh");
				m_Cos = 1;
				break;
			}
			break;
		...
		case 186:
			strcpy(szTexture, "mesh\\ch0101228.wys");
			switch (m_Cos)
			{
			case 1:
				strcpy(szName, "mesh\\ch0101228.msh");
				m_Cos = 2;
				break;
			case 2:
				strcpy(szName, "mesh\\ch0102228.msh");
				m_Cos = 3;
				break;
			case 3:
				strcpy(szName, "mesh\\ch0103228.msh");
				m_Cos = 4;
				break;
			case 4:
				strcpy(szName, "mesh\\ch0104228.msh");
				m_Cos = 5;
				break;
			case 5:
				strcpy(szName, "mesh\\ch0105228.msh");
				m_Cos = 6;
				break;
			case 6:
				strcpy(szName, "mesh\\ch0106228.msh");
				m_Cos = 1;
				break;
			}
			break;
		...
		case 187:
			strcpy(szTexture, "mesh\\ch0101165.wys");
			switch (m_Cos)
			{
			case 1:
				strcpy(szName, "mesh\\ch0101165.msh");
				m_Cos = 2;
				break;
			case 2:
				strcpy(szName, "mesh\\ch0102165.msh");
				m_Cos = 3;
				break;
			case 3:
				strcpy(szName, "mesh\\ch0103165.msh");
				m_Cos = 4;
				break;
			case 4:
				strcpy(szName, "mesh\\ch0104165.msh");
				m_Cos = 5;
				break;
			case 5:
				strcpy(szName, "mesh\\ch0105165.msh");
				m_Cos = 6;
				break;
			case 6:
				strcpy(szName, "mesh\\ch0106165.msh");
				m_Cos = 1;
				break;
			}
			break;
		...
		case 188:
			strcpy(szTexture, "mesh\\ch0101189.wys");
			switch (m_Cos)
			{
			case 1:
				strcpy(szName, "mesh\\ch0101189.msh");
				m_Cos = 2;
				break;
			case 2:
				strcpy(szName, "mesh\\ch0102189.msh");
				m_Cos = 3;
				break;
			case 3:
				strcpy(szName, "mesh\\ch0103189.msh");
				m_Cos = 4;
				break;
			case 4:
				strcpy(szName, "mesh\\ch0104189.msh");
				m_Cos = 5;
				break;
			case 5:
				strcpy(szName, "mesh\\ch0105189.msh");
				m_Cos = 6;
				break;
			case 6:
				strcpy(szName, "mesh\\ch0106189.msh");
				m_Cos = 1;
				break;
			}
			break;
